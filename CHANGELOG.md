...
### Added
- Bundled an `ocr-workflow` skill and installer so the project can be consumed as both an MCP server and a skill-backed OCR workflow.

## [1.0.5] - 2026-03-29

### Changed
- Centralized the repository version source into `VERSION` and added scripts to bump and validate version consistency.
- Updated release, CI, and documentation flows so release-version examples no longer drift from runtime metadata.
...
[1.0.4]: https://github.com/ihugang/ocrtool-mcp/releases/tag/v1.0.4
[1.0.5]: https://github.com/ihugang/ocrtool-mcp/releases/tag/v1.0.5
[1.0.6]: https://github.com/ihugang/ocrtool-mcp/releases/tag/v1.0.6
